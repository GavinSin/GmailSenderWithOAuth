namespace GmailSenderWithOAuth
{
    public class EmailTemplate
    {
        ...
        public static string CreateEmailTemplateHTML(string title, string name, string mainContent, string verificationLink, string postRequestContent)
        {
            ...
            string _TemplateFinal = _TemplateWithButton.Replace("{4}", postRequestContent);

            return _TemplateFinal;
        }
    }
}
